...
const telemetry_util_1 = require("../../utils/telemetry.util");
describe('Telemetry', function () {
    const requestId = 'testRequestId';
    beforeEach(function () {
        telemetry_util_1.Telemetry.clearTelemetry(requestId);
    });
    it('should start a telemetry record', function () {
        telemetry_util_1.Telemetry.start('TestLabel', requestId);
        const records = telemetry_util_1.Telemetry.getTelemetry(requestId);
    ...
    it('should end a telemetry record', function () {
        telemetry_util_1.Telemetry.start('TestLabel', requestId);
        telemetry_util_1.Telemetry.end('TestLabel', requestId);
        const records = telemetry_util_1.Telemetry.getTelemetry(requestId);
        (0, assert_1.strict)(records);
        assert_1.strict.strictEqual(records.length, 1);
        assert_1.strict.strictEqual(records[0].label, 'TestLabel');
    ...
    it('should not end a non-existent telemetry record', function () {
        telemetry_util_1.Telemetry.end('NonExistentLabel', requestId);
        const records = telemetry_util_1.Telemetry.getTelemetry(requestId);
        assert_1.strict.strictEqual(records, null);
    });
    it('should register a plugin', function () {
        const plugin = { name: 'TestPlugin' };
        telemetry_util_1.Telemetry.registerPlugin(plugin);
        const telemetryInstance = telemetry_util_1.Telemetry.getInstance();
    ...
    it('should generate unique ids for telemetry records', function () {
        telemetry_util_1.Telemetry.start('TestLabel1', requestId);
        telemetry_util_1.Telemetry.start('TestLabel2', requestId);
        const records = telemetry_util_1.Telemetry.getTelemetry(requestId);
        (0, assert_1.strict)(records);
    ...
    it('should retrieve all telemetry records', function () {
        telemetry_util_1.Telemetry.start('TestLabel1', requestId);
        telemetry_util_1.Telemetry.start('TestLabel2', requestId);
        const allRecords = telemetry_util_1.Telemetry.getRecords();
