...
exports.ExpressTranspile = void 0;
const fs = require("fs");
const path = require("path");
const core_1 = require("@cmmv/core");
class ExpressTranspile {
    constructor() {
        this.logger = new core_1.Logger('ExpressTranspile');
    }
    run() {
...
export class ${controllerName} {
    ...
    async add(@Body() item: ${contract.controllerName}, @Request() req): Promise<${contract.controllerName}> {
        ...
        ${hasCache ? `CacheService.set(\`${cacheKeyPrefix}\${${core_1.Config.get('repository.type') === 'mongodb' ? `result._id` : `result.id`}}\`, ${contract.controllerName}Schema(result), ${cacheTtl});` : ''}
...
exports.ExpressTranspile = ExpressTranspile;
