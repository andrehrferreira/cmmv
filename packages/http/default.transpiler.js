...
exports.DefaultHTTPTranspiler = void 0;
const fs = require("fs");
const path = require("path");
const core_1 = require("@cmmv/core");
class DefaultHTTPTranspiler {
    constructor() {
        this.logger = new core_1.Logger('DefaultHTTPTranspiler');
    }
    run() {
...
export class ${controllerName} {
    ...
    async add(@Body() item: ${contract.controllerName}, @Request() req) {
        ...
        ${hasCache ? `CacheService.set(\`${cacheKeyPrefix}\${${core_1.Config.get('repository.type') === 'mongodb' ? `result._id` : `result.id`}}\`, ${contract.controllerName}FastSchema(result), ${cacheTtl});` : ''}
...
`;
    ...
    generateModule(controllers, providers) {
        core_1.Application.appModule.controllers = [
            ...core_1.Application.appModule.controllers,
        ...
        core_1.Application.appModule.providers = [
            ...core_1.Application.appModule.providers,
            ...providers.map(name => {
                return {
                    name,
...
exports.DefaultHTTPTranspiler = DefaultHTTPTranspiler;
