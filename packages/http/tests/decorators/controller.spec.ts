...
import { Controller, Get, Post, Put, Delete, Patch, Body, Param, Query, Header, Request, Response } from '../../decorators/controller.decorator';
...
describe('Controller Decorators', () => {
    ...
    it('should register a method with a Body parameter', () => {
        ...
        const params = ControllerRegistry.getParams(TestController.prototype, 'test');
