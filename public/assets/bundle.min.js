...
(t=>{try{var e={app:null,socket:null,contractIndex:{},contracts:{},context:{},contextApp:null,initialize(t,e,n){this.socket=new WebSocket(window.location.href.replace("https","wss").replace("http","ws")),this.socket.addEventListener("message",this.parseMessage.bind(this)),this.socket.binaryType="arraybuffer","object"==typeof t&&(this.context=Object.assign(this.context,t)),document.addEventListener("DOMContentLoaded",this.processExpressions.bind(this))},addContracts:function(t){try{for(var e in this.contractIndex=t.index,t.contracts){var n;t.contracts.hasOwnProperty(e)&&(n=protobuf.Root.fromJSON(t.contracts[e]),this.contracts[e]=n)}}catch(t){console.error("Error loading contracts:",t)}},getContract:function(t){return this.contracts[t]},parseMessage(t){},pack(t,e,n){var o,s,c;return this.contracts.has(t)&&this.index.has(t)?(s=(o=this.index.get(t))?.types[e.replace(t+".","")],c=(c=this.contracts.get(t)?.lookupType(e))&&n?c.encode(n).finish():null,(n=(this.contracts.get("ws")?.lookupType("ws.Call"))?.encode({contract:o?.index,message:s,data:c&&c instanceof Uint8Array?c:new Uint8Array}).finish())?new Uint8Array(n):null):(console.error(`Not found in contract list ${t}.`+e),null)},processExpressions(){this.contextApp=this.reactive({$template:"#app",...this,rpc:this.rpc,...this.context,mounted:this.mounted,created:this.created});var t=this.createApp(this.contextApp);"function"==typeof this.contextApp?.created&&this.contextApp?.created(),this.app=t.mount(),"function"==typeof this.contextApp?.mounted&&this.contextApp?.mounted()},rpc:{get:t=>"tasks"===t?[{key:1,label:"Task 1"},{key:2,label:"Task 2"},{key:3,label:"Task 3"}]:[],add:(t,e)=>{console.log(t,e)},on:(t,e)=>{}}},n={};if("object"==typeof __methods)for(var o in __methods)n[o]=new Function(`return (${__methods[o]})`)();var s=__mounted?new Function(`return (${__mounted})`)():null;t.cmmv=Object.assign({...n,mounted:s},cmmv,e),t.cmmv.initialize(__data||{})}catch(t){console.error(t)}})("undefined"!=typeof window?window:global);

(e=>{try{e.cmmv.addContracts({index:{tasks:{index:0,types:{}},ws:{index:1,types:{wscall:0,AddwscallRequest:1,AddwscallResponse:2,UpdatewscallRequest:3,UpdatewscallResponse:4,DeletewscallRequest:5,DeletewscallResponse:6,GetAllwscallRequest:7,GetAllwscallResponse:8,wscallService:9}}},contracts:{tasks:{options:{syntax:"proto3"},nested:{Task:{fields:{label:{type:"string",id:1},checked:{type:"bool",id:2},removed:{type:"bool",id:3}}},TaskList:{fields:{items:{rule:"repeated",type:"Task",id:1}}},AddTaskRequest:{fields:{item:{type:"Task",id:1}}},AddTaskResponse:{fields:{item:{type:"Task",id:1}}},UpdateTaskRequest:{fields:{id:{type:"string",id:1},item:{type:"Task",id:2}}},UpdateTaskResponse:{fields:{item:{type:"Task",id:1}}},DeleteTaskRequest:{fields:{id:{type:"string",id:1}}},DeleteTaskResponse:{fields:{success:{type:"bool",id:1}}},GetAllTaskRequest:{fields:{}},GetAllTaskResponse:{fields:{items:{type:"TaskList",id:1}}},TaskService:{methods:{AddTask:{requestType:"AddTaskRequest",responseType:"AddTaskResponse"},UpdateTask:{requestType:"UpdateTaskRequest",responseType:"UpdateTaskResponse"},DeleteTask:{requestType:"DeleteTaskRequest",responseType:"DeleteTaskResponse"},GetAllTask:{requestType:"GetAllTaskRequest",responseType:"GetAllTaskResponse"}}}}},ws:{options:{syntax:"proto3"},nested:{ws:{nested:{wscall:{fields:{contract:{type:"int32",id:1},message:{type:"int32",id:2},data:{type:"bytes",id:3}}},AddwscallRequest:{fields:{item:{type:"wscall",id:1}}},AddwscallResponse:{fields:{item:{type:"wscall",id:1}}},UpdatewscallRequest:{fields:{id:{type:"string",id:1},item:{type:"wscall",id:2}}},UpdatewscallResponse:{fields:{item:{type:"wscall",id:1}}},DeletewscallRequest:{fields:{id:{type:"string",id:1}}},DeletewscallResponse:{fields:{success:{type:"bool",id:1}}},GetAllwscallRequest:{fields:{}},GetAllwscallResponse:{fields:{items:{type:"wscallList",id:1}}},wscallService:{methods:{Addwscall:{requestType:"AddwscallRequest",responseType:"AddwscallResponse"},Updatewscall:{requestType:"UpdatewscallRequest",responseType:"UpdatewscallResponse"},Deletewscall:{requestType:"DeletewscallRequest",responseType:"DeletewscallResponse"},GetAllwscall:{requestType:"GetAllwscallRequest",responseType:"GetAllwscallResponse"}}}}}}}}})}catch(e){console.error("Error loading contracts:",e)}})("undefined"!=typeof window?window:global);
